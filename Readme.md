## This repo is being moved to NEXT.js and TypeScript, this legacy branch will act like a template for convertion, main branch is next-typescript-migration, both the og and fork are planned to be parallely developed
